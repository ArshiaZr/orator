...
export default function UploadPages() {
    return (
        <div className="w-screen h-screen">
            ...
            <div className="absolute inset-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/2 h-2/5 justify-center border border-black">
                <div>
                ...
                <Upload/>
                <div className="absolute inset-1/2 transform -translate-x-1/2 translate-y-full w-1/4 h-1/5 md:rounded-md xl:rounded-lg p-4">
